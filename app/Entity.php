...
class Entity extends Model
{
  ...
  public static function ShowMultiStyledForEdit2($EntityShowMultiForEdit,$EntityType)
  {

    function ShowMultiStyledForEditHelper2($Identifier, $EntityShowMultiForEdit, $Attr,$EntityType)
    {
            ...
            if (is_array($value2)) {
              if ('folder' == $value2[$Attr[1]]) {
                ...
                <li>
                  ...
                  ob_end_clean();
                  $result .= ShowMultiStyledForEditHelper2($CurrentIdentifier, $value2, $Attr,$EntityType);
    ...
    $Attr = Entity::ShowAttributeTypes();
    $result = ShowMultiStyledForEditHelper2($Identifier, $EntityShowMultiForEdit, $Attr,$EntityType);
